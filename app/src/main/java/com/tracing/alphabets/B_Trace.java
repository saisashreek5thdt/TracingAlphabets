...
public class B_Trace extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_b__trace);

        startService(new Intent(getBaseContext(),MyService.class));
        textSource = (TextView)findViewById(R.id.sourceuri);
        imageResult = (ImageView)findViewById(R.id.result);

        RelativeLayout mtile=(RelativeLayout)findViewById(R.id.traceb);
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if(count_complete == 20) {
                        ...
                        Intent b = new Intent(B_Trace.this, C_Trace.class);
    ...
    {
        super.onBackPressed();
        startActivity(new Intent(B_Trace.this, A_Trace.class));
        finish();
